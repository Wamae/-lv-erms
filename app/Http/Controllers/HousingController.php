...
class HousingController extends Controller {
    ...
    public function index() {
        ...
        $subCategories = SubCategory::select(['id', 'sub_category'])
                ->where('status', '=', ACTIVE)
                ->where('category_id', '=', HOUSING)
                ->get();

        return view('housing.index', compact('title','subCategories'));
    }
    ...
    public function grid(Request $request) {
        return datatables(
                        DB::table('documents')
                                ...
                                ])->where('documents.category_id','=',HOUSING)->orderBy('documents.id', 'DESC')->groupBy(['documents.id']))->toJson();
    }
