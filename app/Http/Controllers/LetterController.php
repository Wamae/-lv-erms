...
class LetterController extends Controller {
    ...
    public function index() {
        ...
        return view('letters.index', compact('title','subCategories'));
    }
    ...
    public function grid(Request $request) {
        return datatables(
                        DB::table('documents')
                                ...
                                ])->where('documents.category_id','=',LETTER)->orderBy('documents.id', 'DESC')->groupBy(['documents.id']))->toJson();
    }
    ...
    public function store(Request $request) {
        ...
        if ($validator->passes()) {
            ...
            if ($uploadSuccess) {
                ...
                if ($result) {
                    return response()->json(array("type" => "success", "text" => "Letter added successfully"), 200);
                } else {
                    return response()->json(array("type" => "error", "text" => "Adding letter failed"), 200);
                }
            } else {
