...
class MemoController extends Controller {
    ...
    public function index() {
        ...
        $subCategories = SubCategory::select(['id', 'sub_category'])
                ->where('status', '=', ACTIVE)
                ->where('category_id', '=', MEMO)
                ->get();

        return view('memos.index', compact('title','subCategories'));
    }
    ...
    public function grid(Request $request) {
        return datatables(
                        DB::table('documents')
                                ...
                                ])->where('documents.category_id','=',MEMO)->orderBy('documents.id', 'DESC')->groupBy(['documents.id']))->toJson();
    }
