                        ...
                        <ul class="sidebar-menu tree" data-widget="tree">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    @can('view roles')
                                    <li><a href="{{url('roles')}}"><i class="fa fa-shekel"></i> Roles</a></li>
                                    @endcan
                                    ...
                                    <li><a href="{{url('sub_categories')}}"><i class="fa fa-bars"></i> Sub Categories</a></li>
                                    @endcan
                                </ul>
                            </li>                            
                            
                            <li><a href="https://adminlte.io/docs"><i class="fa fa-mail-reply"></i> <span>Letters</span></a></li>
                            <li><a href="https://adminlte.io/docs"><i class="fa fa-edit"></i> <span>Memos</span></a></li>
                            <li><a href="{{url('sub_categories')}}"><i class="fa fa-file"></i> <span>Other Documents</span></a></li>
