...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-lg-12">
            @can('add document')
            <a id="add-document" href="#" class="btn btn-primary"><span class="fa fa-plus"></span> Create Letter</a>
            @endcan
            </div>
...
<script>
    const TITLE = "{{$title}}";
    const ORIGINAL_LETTERS_URL = "{{url('letters')}}";
    const GET_SUB_CATEGORIES_URL = "{{url('get_sub_categories')}}";
    const DOCUMENTS_URL = "{{url('/uploads/documents')}}";
    const LETTERS_GRID_URL = "{{url('letters_grid') }}";
    const CREATE_LETTERS_URL = "{{ URL::to('letters/create') }}";
    const DELETE_LETTERS_URL = "{{url('letters')}}";
    var method = "";
    var url = "";
