...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-lg-12">
            @can('add document')
            <a id="add-document" href="#" class="btn btn-primary"><span class="fa fa-plus"></span> Create Memo</a>
            @endcan
            </div>
